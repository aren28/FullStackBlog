...
-- AddForeignKey
ALTER TABLE "public"."Post" ADD CONSTRAINT "Post_userProfile_fkey" FOREIGN KEY ("userProfileId") REFERENCES "public"."Profiles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
